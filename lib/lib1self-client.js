(function (root, factory) {
    ...
    Lib1selfClient.prototype.registerStream = function (callback) {
        ...
        var parseResponse= function(response) {
            ...
            stream.streamid(response.streamid);
            stream.readToken(response.readToken);
            stream.writeToken(response.writeToken);
            return stream;
        };
    ...
    Lib1selfClient.prototype.fetchStream = function(callback) {
        if (config.streamid !== 'undefined' && config.writeToken !== 'undefined' && config.readToken !== 'undefined' ) {
            var stream = new Stream();
            stream.streamid(config.streamid);
            stream.readToken(config.readToken);
            stream.writeToken(config.writeToken);
    ...
    Lib1selfClient.prototype.visualize = function (stream) {
        config.streamid = stream.streamid();
    ...
    Lib1selfClient.prototype.url = function () {
        //Check
