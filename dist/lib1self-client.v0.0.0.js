...
(function (root, factory) {
    ...
    Lib1selfClient.prototype.sendEvent = function (event, streamid, writeToken) {
    ...
    Lib1selfClient.prototype.sendEvents = function (events, streamid, writeToken) {
        if (!writeToken) {
            throw (new Error("streamid, writeToken needs to be specified"));
        }
    ...
    Lib1selfClient.prototype.visualize = function (streamid, readToken) {
        config.streamid = streamid;
